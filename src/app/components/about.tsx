        ...
        <div>
            ...
            >
                <p>
                    ...
                    I thrive on the excitement of bringing ideas to life and tackling new challenges in every project. Unlike most developers, I don't drink coffee or tea, but my passion for coding drives me to continuously improve and innovate.
                </p>
            </div>
        </div>
